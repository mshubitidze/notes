...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center gap-10 bg-gradient-to-b from-[#2e026d] to-[#15162c] px-8 pt-14 md:px-20 lg:px-44">
        <Auth />
          ...
          <>
            ...
            >
              <fieldset className="flex flex-col gap-1 w-full text-white">
                <label htmlFor="note-input" className="text-3xl">
                  Add Note
                </label>
                <input
                  className="py-4 px-8 text-xl rounded-lg border outline-none border-white/10 bg-white/10 hover:border-white/20"
                  value={note}
              ...
              <button
                disabled={!note}
                type="submit"
                className="py-3 px-6 w-1/3 text-white rounded-lg border disabled:border border-white/10 bg-white/10 hover:bg-white/20 disabled:border-white/10 disabled:bg-white/0"
              >
                Submit
              </button>
            </form>

            <div className="flex flex-col gap-4 p-8 w-full rounded-lg select-none">
