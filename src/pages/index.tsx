...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen w-full justify-center flex-col items-center gap-10 bg-gradient-to-b from-[#2e026d] to-[#15162c]">
        <Auth />
        {sessionData?.user.name && (
          <>
            <form
              className="flex flex-col md:flex-row gap-4 justify-center items-center w-3/4 text-lg md:text-xl"
            ...
            >
              <fieldset className="flex flex-col gap-1 w-full text-white">
                ...
                <input
                  className="py-2 px-4 md:py-4 md:px-8 rounded-lg border outline-none border-white/10 bg-white/10 hover:border-white/20"
                  value={note}
              ...
              <button
                disabled={!note}
                type="submit"
                className="flex flex-row gap-2 justify-center items-center md:self-end md:py-4 md:px-8 py-2 px-4 text-white rounded-lg border disabled:border border-white/10 bg-white/10 hover:bg-white/20 disabled:border-white/10 disabled:bg-white/0"
              >
                Return
              </button>
            </form>
            ...
            <div className="flex flex-col gap-4 w-3/4 rounded-lg select-none">
              <h1 className="text-lg md:text-2xl text-white">Notes</h1>
