...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen w-full flex-col items-center justify-between gap-10">
        <Auth />
                  ...
                  fetchedUserNotes?.map((note) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        type="button"
                        className="mr-2 hover:bg-white/10 text-pink-500 rounded-lg min-h-[2rem] min-w-[2rem]"
                      >
                        <svg
