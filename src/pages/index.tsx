...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-items-start gap-10 bg-gradient-to-b from-[#2e026d] to-[#15162c] px-8 md:px-20 lg:px-44">
        <div className="flex w-full flex-row items-center gap-2 m-4">
          {sessionData && (
            <>
              <Image
                width={55}
                ...
                {fetchedUserNotes?.map((note) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      type="button"
                      className="rounded-lg p-4 min-h-[2rem] min-w-[2rem]"
                    >
